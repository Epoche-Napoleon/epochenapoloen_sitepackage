...
class MapService
{
    ...
    public function showAllowMapForm(): string
    {
        ...
        //Nitsan
        // Main URL
        $mapParams = $this->getRequestUri();
        //fetch the current URL
        $uri = GeneralUtility::getIndpEnv('TYPO3_REQUEST_URL');
        $mapParams = explode('?', $mapParams);
        // re generated URL
        $requestUri = $uri . '?' . $mapParams[1];
        $view->assign('requestUri', $requestUri);
    ...
    protected function getRequestUri(): string
    {
        ...
        return $uriBuilder->setAddQueryString(true)
            ->setArguments([
                'tx_maps2_maps2' => [
    ...
    public function assignPoiCollectionToForeignRecord(
        ...
        $hasErrors = false;
        $messageHelper = Genera lUtility::makeInstance(MessageHelper::class);
